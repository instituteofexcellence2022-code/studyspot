...
import { fetchAnalytics, fetchCurrentTenant } from '../../store/slices/tenantSlice';
...
const AnalyticsDashboard: React.FC = () => {
  ...
  useEffect(() => {
    if (user?.tenantId) {
      dispatch(fetchCurrentTenant(true)); // Pass true to fetch current tenant
    }
  }, [dispatch]);

  useEffect(() => {
    if (currentTenant) {
      dispatch(fetchAnalytics({ id: currentTenant.id }));
    }
