...
export const USER_ROLES = {
  ...
  LIBRARY_ADMIN: 'library_admin',          // Library administration
  ...
  FINANCE_MANAGER: 'finance_manager',      // Financial management
  ANALYTICS_MANAGER: 'analytics_manager',  // Analytics management
  LIBRARIAN: 'librarian',                  // Librarian role
