...
import {
  ...
  Sankey as SankeyChartIcon2,
  TreeMap as TreeMapIcon2,
  HeatMap as HeatMapIcon2,
  Radar as RadarChartIcon2,
  PolarChart as PolarChartIcon2,
  Gauge as GaugeChartIcon2,
  Speedometer as SpeedometerIcon2,
  DashboardCustomize as CustomDashboardIcon2,
  ViewModule as ModuleIcon2,
  ViewList as ListViewIcon2,
  ViewGrid as GridViewIcon2,
