...
app.get('/api/credits/packages', (req, res) => {
  res.json({
    success: true,
    data: [
      { id: '1', name: 'Starter Pack', credit_amount: 100, price: 10, bonus_credits: 0 },
      { id: '2', name: 'Growth Pack', credit_amount: 500, price: 45, bonus_credits: 50 },
      { id: '3', name: 'Pro Pack', credit_amount: 1000, price: 80, bonus_credits: 200 },
      { id: '4', name: 'Enterprise Pack', credit_amount: 5000, price: 350, bonus_credits: 1000 }
    ]
  });
});
