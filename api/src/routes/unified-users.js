 ...
 */
router.post('/', 
  authorize('super_admin', 'branch_manager', 'library_owner'),
  [
    ...
    body('role').optional().isIn(['student', 'staff', 'library_staff', 'library_owner', 'branch_manager']).withMessage('Invalid role'),
...
router.put('/:userId',
  ...
  [
    ...
    body('role').optional().isIn(['student', 'staff', 'library_staff', 'library_owner', 'branch_manager']),
