...
const seedData = () => {
  ...
  insertUser.run(
    ...
    'admin@studyspot.com',
    '$2b$10$rKjHvLNnN8K5yFZ4YQ5YLOqYxKZQwx7xKvKJXZQwx7xKvKJXZQwx7', // hashed: Admin@123
    'Admin',
    'User',
    '+919876543210',
    'super_admin',
  ...
  const plans = [
    {
      ...
      limits: JSON.stringify({ max_libraries: 1, max_bookings_per_month: 100 })
    },
    {
      id: 'plan-starter',
      name: 'starter',
      ...
      limits: JSON.stringify({ max_libraries: 5, max_bookings_per_month: 500 })
    },
    {
      id: 'plan-pro',
      name: 'pro',
      ...
      limits: JSON.stringify({ max_libraries: -1, max_bookings_per_month: -1 })
    }
  ];
