  ...
  try {
    ...
    const libraries = [
      {
        ...
        pricing: { hourly: 50, daily: 300, weekly: 1500, monthly: 5000 },
        openingTime: '06:00',
        closingTime: '23:00',
        rating: 4.5
      },
      {
        ...
        pricing: { hourly: 40, daily: 250, weekly: 1200, monthly: 4000 },
        openingTime: '07:00',
        closingTime: '22:00',
        rating: 4.2
      },
      {
        ...
        pricing: { hourly: 60, daily: 350, weekly: 1800, monthly: 6000 },
        openingTime: '00:00',
        closingTime: '23:59',
        rating: 4.7
      },
      {
        ...
        pricing: { hourly: 35, daily: 200, weekly: 1000, monthly: 3500 },
        openingTime: '06:00',
        closingTime: '22:00',
        rating: 4.0
      },
      {
        ...
        pricing: { hourly: 55, daily: 320, weekly: 1600, monthly: 5500 },
        openingTime: '06:00',
        closingTime: '23:00',
        rating: 4.6
      },
      {
        ...
        pricing: { hourly: 45, daily: 280, weekly: 1400, monthly: 4500 },
        openingTime: '07:00',
        closingTime: '21:00',
        rating: 4.3
      }
    ...
    for (const library of libraries) {
      const result = await client.query(`
        ...
        RETURNING id
      `, [
        tenantId, library.name, library.slug, library.description, library.address,
        library.city, library.state, library.capacity, library.availableSeats,
        library.amenities, JSON.stringify(library.pricing), library.openingTime,
        library.closingTime, library.rating
      ]);
      
      libraryIds.push({ ...library, id: result.rows[0].id });
    ...
    const bookings = [
      {
        userId: userIds[1].id, // Priya
        libraryId: libraryIds[0].id, // Central Study Hub
        seatNumber: 'A-15',
        bookingDate: today,
        startTime: '09:00',
        endTime: '17:00',
      ...
      {
        userId: userIds[2].id, // Amit
        libraryId: libraryIds[2].id, // Smart Library Mumbai
        seatNumber: 'B-22',
        bookingDate: today,
        startTime: '10:00',
        endTime: '18:00',
      ...
      {
        userId: userIds[3].id, // Sneha
        libraryId: libraryIds[1].id, // Knowledge Corner
        seatNumber: 'C-08',
    ...
    for (const booking of bookings) {
      const result = await client.query(`
        ...
        RETURNING id
      `, [
        booking.userId, booking.libraryId, booking.seatNumber, booking.bookingDate,
        booking.startTime, booking.endTime, booking.status, booking.amount, booking.paymentStatus
      ]);
      
      bookingIds.push({ ...booking, id: result.rows[0].id });
    }
    ...
    for (const user of userIds.slice(1)) { // Skip admin
      await client.query(`
