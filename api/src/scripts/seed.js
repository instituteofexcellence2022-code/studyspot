...
async function seedDatabase() {
  ...
  try {
    ...
    if (parseInt(existingUsers.rows[0].count) > 1) { // More than just the default admin
    ...
    const seatData = [];
    const libraries = [
      { id: '11111111-1111-1111-1111-111111111111', name: 'StudyHub Central' },
      { id: '22222222-2222-2222-2222-222222222222', name: 'Quiet Corner Library' },
      { id: '33333333-3333-3333-3333-333333333333', name: 'Tech Study Center' }
    ];
    ...
    libraries.forEach(library => {
      ...
      for (let i = 1; i <= 20; i++) {
        ...
        const amenities = zone === 'quiet' ? '["power_outlet", "lamp"]' : 
                         zone === 'group' ? '["power_outlet", "whiteboard"]' : 
                         '["power_outlet"]';
        ...
        seatData.push({
          ...
          seat_type: seatType,
          amenities,
          location: JSON.stringify({ floor: 1, section: zone, x: (i-1) % 5, y: Math.floor((i-1)/5) })
        });
      }
    });
