...
const ROLES = {
  ...
  FRONT_DESK_STAFF: 'front_desk_staff',    // Daily operations & student interactions
  FACILITY_MANAGER: 'facility_manager',     // Maintenance & facility management
...
const ROLE_PERMISSIONS = {
  ...
  [ROLES.LIBRARY_OWNER]: [
    ...
    'seats:edit_layout',
    'seats:manage_zones',
    'seats:view_availability',
    'seats:configure_shifts',
    'bookings:view',
    'bookings:create',
    'bookings:edit',
    'bookings:cancel',
    ...
    'marketing:manage_referrals',
    'marketing:manage_discounts',
    ...
    'analytics:export',
    'analytics:view_predictions',
    'iot:view_devices',
    'iot:control_devices',
    'iot:manage_automation',
    'iot:view_energy',
    'branches:view_all',
    'branches:create',
    'branches:edit',
    'branches:delete',
    'branches:view_analytics',
    'subscription:view',
    'subscription:manage',
    'subscription:view_invoices',
    'system:configure',
