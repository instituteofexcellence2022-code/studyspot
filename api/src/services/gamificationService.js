...
class GamificationService {
  constructor() {
    ...
    this.POINTS = {
      ...
      PROFILE_COMPLETE: 25,
      PHOTO_UPLOAD: 10,
      EARLY_BOOKING: 5, // Book 3+ days in advance
    ...
    this.BADGES = {
      ...
      FIRST_STEP: {
        ...
        icon: '🎯',
        tier: 'bronze',
        requirement: { type: 'bookings_count', value: 1 }
      },
      GETTING_STARTED: {
        id: 'getting_started',
      ...
      REGULAR_STUDENT: {
        ...
        icon: '📚',
        tier: 'silver',
        requirement: { type: 'bookings_count', value: 10 }
      },
      DEDICATED_LEARNER: {
        ...
        icon: '🎓',
        tier: 'gold',
        requirement: { type: 'bookings_count', value: 50 }
      },
      KNOWLEDGE_SEEKER: {
        id: 'knowledge_seeker',
        ...
        icon: '🏆',
        tier: 'platinum',
        requirement: { type: 'bookings_count', value: 100 }
      },
      ...
      STUDY_CHAMPION: {
        ...
        icon: '👑',
        tier: 'gold',
        requirement: { type: 'study_hours', value: 200 }
      },
      ...
      COMMUNITY_BUILDER: {
        ...
        icon: '⭐',
        tier: 'silver',
        requirement: { type: 'reviews_count', value: 10 }
      },
      REFERRAL_STAR: {
        id: 'referral_star',
        name: 'Referral Star',
      ...
      LIBRARY_HOPPER: {
        ...
        icon: '🏛️',
        tier: 'gold',
        requirement: { type: 'unique_libraries', value: 10 }
      },
      ...
      EARLY_BIRD: {
        ...
        icon: '🐦',
        tier: 'silver',
        requirement: { type: 'early_bookings', value: 10 }
      },
      WEEKEND_WARRIOR: {
        id: 'weekend_warrior',
    ...
    // Levels system
    this.LEVELS = [
      { level: 1, name: 'Beginner', minPoints: 0, maxPoints: 100, icon: '🌱' },
      { level: 2, name: 'Student', minPoints: 101, maxPoints: 300, icon: '📖' },
      { level: 3, name: 'Scholar', minPoints: 301, maxPoints: 600, icon: '📚' },
      { level: 4, name: 'Expert', minPoints: 601, maxPoints: 1000, icon: '🎓' },
      { level: 5, name: 'Master', minPoints: 1001, maxPoints: 1500, icon: '👨‍🎓' },
      { level: 6, name: 'Legend', minPoints: 1501, maxPoints: 2500, icon: '🏆' },
      { level: 7, name: 'Champion', minPoints: 2501, maxPoints: 5000, icon: '👑' },
      { level: 8, name: 'Grandmaster', minPoints: 5001, maxPoints: 10000, icon: '💎' },
      { level: 9, name: 'Elite', minPoints: 10001, maxPoints: 20000, icon: '⭐' },
      { level: 10, name: 'Legendary', minPoints: 20001, maxPoints: Infinity, icon: '🌟' }
    ];
  }
  ...
  getAvailableRewards(totalPoints) {
    const rewards = [
      { id: 'discount_10', name: '10% Off Next Booking', cost: 100, type: 'discount', value: 10 },
      { id: 'discount_20', name: '20% Off Next Booking', cost: 250, type: 'discount', value: 20 },
      { id: 'free_coffee', name: 'Free Coffee Voucher', cost: 50, type: 'voucher', value: 'coffee' },
      { id: 'free_hour', name: '1 Free Hour', cost: 150, type: 'freebie', value: '1_hour' },
      { id: 'free_day', name: '1 Free Day Pass', cost: 500, type: 'freebie', value: '1_day' },
      { id: 'priority_booking', name: 'Priority Booking (1 week)', cost: 200, type: 'upgrade', value: '7_days' },
      { id: 'premium_seat', name: 'Premium Seat Upgrade', cost: 100, type: 'upgrade', value: 'premium_seat' },
      { id: 'refer_bonus', name: 'Double Referral Points', cost: 300, type: 'multiplier', value: '2x' }
    ];
