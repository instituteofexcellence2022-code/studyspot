...
router.get('/', async (req, res) => {
  try {
    ...
    const errorRate = metrics.requests.total > 0 ? (metrics.requests.error / metrics.requests.total * 100).toFixed(2) : '0.00';
    ...
    const metricsData = {
      ...
      performance: {
        ...
        minResponseTime: metrics.responseTime.min === Infinity ? '0ms' : `${metrics.responseTime.min}ms`,
